...
p(2).legend = {'tracker', 'sonar', 'quality > 90%'};

p(4).legend = {'v_{x,raw}', 'v_{x,filtered}'};
p(5).legend = {'v_{y,raw}', 'v_{y,filtered}'};
p(6).legend = {'v_{z,raw}', 'v_{z,filtered}'};

p(7).legend = {'tracker', 'optical flow', 'quality > 90%'};
p(8).legend = {'tracker', 'optical flow', 'quality > 90%'};
p(9).legend = {'tracker', 'optical flow', 'quality > 90%'};
